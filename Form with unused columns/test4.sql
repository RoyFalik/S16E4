...
BEGIN
    ...
    sys.dbms_output.put_line('match_count: '||match_count);
...
BEGIN
    ...
    sys.dbms_output.put_line('Starting doLOV');
    apex_debug.log_dbms_output; 
    ...
    sys.dbms_output.put_line('query built');
    apex_debug.log_dbms_output; 
    ...
    sys.dbms_output.put_line('query fired');
    apex_debug.log_dbms_output; 
    ...
    sys.dbms_output.put_line('clob parsed');
    apex_debug.log_dbms_output; 
    ...
    sys.dbms_output.put_line('rows returned: '||ret_val_column);
    apex_debug.log_dbms_output; 
    ...
    sys.dbms_output.put_line('display column: '||display_value_column);
    sys.dbms_output.put_line('match count: '||column_names_in_expression(1));
